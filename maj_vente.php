<?php 
	...
	if(!empty($_POST))
	{
		...
		{
			$errors['nombre'] = "Le nombre de vente doit être une valeur numérique";
		}

		if($_POST['compteur'] != 0)
		{
			$errors['actualisation'] = "Le nombre de vente doit être égale à 0";
		}

		if(empty($errors))
		{
			mettreVenteAZero();
			$_SESSION['flash']['success'] = 'Toutes les ventes ont été remis à 0';
...
<div class="container">
	...
	<?php endif; ?>
	<h3 style="color: #531B51;"><b>MODIFIER LES VENTES</b></h3>
	<form style="width: 50%;" action="" method="POST">
		<div class="form-group mt-4">
			<label style="color: #531B51;">Remettre toutes les ventes à 0 : </label>
			<input type="text" name="compteur" class="form-control" placeholder="Mettre les ventes à 0" required>
	    </div>
